...
namespace WorldOfZuul
{
    public class Game
    {
        ...
        private void CreateRooms()
        {
            ...
            Room? theatre = new("Farm", "There is a farm in front of you. Beautfiul flowers and huge trees are covering all way around. If you look more carefully, you can see that there are lots of hives for bees But why honey is not existing inside the hives? Interesting!");
